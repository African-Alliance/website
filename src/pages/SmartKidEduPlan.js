      ...
      <div className="product-content d-flex flex-column flex-md-row justify-content-center mt-3 mt-md-5 mx-2 mx-md-0">
        ...
        <div className="intro-text col-12 col-md-6 px-4">
          <p className="caption-subtitle typo20">
            The African Alliance Smart Kid Educational Plan is perfect for you
            if you have children and you are determined to give them a much
            higher quality of education than you had, whether you are around for
            that event or not.
          </p>

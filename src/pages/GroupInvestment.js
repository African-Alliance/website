...
import banner from '../assets/group investment.jpg';
      ...
      <div className='intro-container'>
        ...
        <div className="product-content d-flex flex-column flex-md-row justify-content-center mt-3 mt-md-5 mx-2 mx-md-auto">
          <div className="intro-header text-left text-md-right col-12 col-md-6 typo48 px-4 d-flex align-items-center justify-content-start justify-content-md-end">
            <h3>Group Alliance Income Plan</h3>
          </div>
          <div className="intro-bar"></div>
          <div className="intro-text col-12 col-md-6 px-4">
            {/* <p className="caption-subtitle typo20"> */}
            <p>
              With the Group Alliance Income Plan, a special plan designed for organizations, corporate bodies etc. add more text here
            </p>
        ...
        {/* <div className="investment-container d-flex flex-column align-items-md-start flex-lg-row col-md-9 my-3 pt-md-4 my-md-5 align-items-center justify-content-start">
          <img className="mr-lg-4" src={banner} alt='product' />
          <div className='investment-text d-flex flex-column justify-content-between mt-3 mt-md-5 mt-lg-0 mx-2 mx-sm-4 mx-md-auto'>
            ...
            <div className="col-12 px-md-0">
              <p className='my-2 my-md-3 w-100 '>The Group Alliance Income Plan provides you with an added advantage over
        ...
        <div className="investment-container d-flex flex-column align-items-md-start flex-md-row col-md-12 col-lg-9 my-3 pt-md-4 my-md-5 align-items-center justify-content-center">
          <div className="col-12 col-md-6 col-lg-4">
            ...
            <p>While all individual under is under a policy, an individualclaim can be treated when needed as requested by the group</p>
          </div>
